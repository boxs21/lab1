...
- Kernel used for the saved notebook outputs: Python 3.14.3, pandas 2.3.1 (printed by the first notebook cell). numpy: [2.4.6]. matplotlib: [3.11.1].
...
- Final Restart & Run All: [23/09/2026 20:13hrs] · result: [ran without errors] · submitted commit: [hash].
